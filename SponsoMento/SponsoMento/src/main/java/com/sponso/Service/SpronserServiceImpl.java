...
import com.sponso.repo.MentorLinkRepo;
...
public class SpronserServiceImpl implements SponserService {
	...
	public boolean mentor(MentorLink link){
		if(mrepo.save(link)!=null)
			return true;
		else
			return false;
	}
	
	public List<MentorLink> getMentored(int id){
		return mrepo.findBySponsorId(id);
	}
